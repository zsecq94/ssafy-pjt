...
#ifndef TURTLEBOT3_MSGS__MSG__SOUND__STRUCT_HPP_
#define TURTLEBOT3_MSGS__MSG__SOUND__STRUCT_HPP_
...
struct Sound_
{
  ...
  explicit Sound_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Sound_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // TURTLEBOT3_MSGS__MSG__SOUND__STRUCT_HPP_
