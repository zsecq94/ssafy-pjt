...
#ifndef TURTLEBOT3_MSGS__MSG__SENSOR_STATE__STRUCT_HPP_
#define TURTLEBOT3_MSGS__MSG__SENSOR_STATE__STRUCT_HPP_
...
struct SensorState_
{
  ...
  explicit SensorState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit SensorState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // TURTLEBOT3_MSGS__MSG__SENSOR_STATE__STRUCT_HPP_
