...
bool gazebo_msgs__srv__get_light_properties__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._get_light_properties.GetLightProperties_Request",
  ...
  {  // light_name
    ...
    rosidl_generator_c__String__assign(&ros_message->light_name, PyBytes_AS_STRING(encoded_field));
...
bool gazebo_msgs__srv__get_light_properties__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._get_light_properties.GetLightProperties_Response",
