...
bool gazebo_msgs__srv__spawn_entity__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._spawn_entity.SpawnEntity_Request",
  ...
  {  // xml
    ...
    rosidl_generator_c__String__assign(&ros_message->xml, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // robot_namespace
...
bool gazebo_msgs__srv__spawn_entity__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._spawn_entity.SpawnEntity_Response",
