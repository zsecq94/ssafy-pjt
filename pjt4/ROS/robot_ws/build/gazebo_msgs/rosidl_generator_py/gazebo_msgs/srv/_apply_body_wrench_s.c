...
bool gazebo_msgs__srv__apply_body_wrench__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._apply_body_wrench.ApplyBodyWrench_Request",
  ...
  {  // body_name
    ...
    rosidl_generator_c__String__assign(&ros_message->body_name, PyBytes_AS_STRING(encoded_field));
...
bool gazebo_msgs__srv__apply_body_wrench__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._apply_body_wrench.ApplyBodyWrench_Response",
