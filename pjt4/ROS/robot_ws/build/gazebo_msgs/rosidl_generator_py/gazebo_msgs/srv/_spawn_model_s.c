...
bool gazebo_msgs__srv__spawn_model__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._spawn_model.SpawnModel_Request",
  ...
  {  // model_xml
    ...
    rosidl_generator_c__String__assign(&ros_message->model_xml, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // robot_namespace
    ...
    rosidl_generator_c__String__assign(&ros_message->robot_namespace, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // initial_pose
  ...
  {  // reference_frame
    ...
    rosidl_generator_c__String__assign(&ros_message->reference_frame, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
bool gazebo_msgs__srv__spawn_model__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.srv._spawn_model.SpawnModel_Response",
