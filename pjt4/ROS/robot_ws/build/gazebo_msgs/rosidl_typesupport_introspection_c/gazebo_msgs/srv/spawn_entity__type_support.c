...
#include <stddef.h>
#include "gazebo_msgs/srv/spawn_entity__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_service_members = {
  "gazebo_msgs__srv",  // service namespace
  "SpawnEntity",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_Request_message_type_support_handle,
  NULL  // response message
  // gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_Response_message_type_support_handle
};

static rosidl_service_type_support_t gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_service_type_support_handle = {
  0,
  &gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, SpawnEntity)() {
  if (!gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_service_type_support_handle.typesupport_identifier) {
    gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_service_type_support_handle.data;
  ...
  return &gazebo_msgs__srv__spawn_entity__rosidl_typesupport_introspection_c__SpawnEntity_service_type_support_handle;
}
