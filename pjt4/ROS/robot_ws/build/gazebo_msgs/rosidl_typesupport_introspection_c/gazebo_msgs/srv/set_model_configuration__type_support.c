...
#include <stddef.h>
#include "gazebo_msgs/srv/set_model_configuration__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_service_members = {
  "gazebo_msgs__srv",  // service namespace
  "SetModelConfiguration",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_Request_message_type_support_handle,
  NULL  // response message
  // gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_Response_message_type_support_handle
};

static rosidl_service_type_support_t gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_service_type_support_handle = {
  0,
  &gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, SetModelConfiguration)() {
  if (!gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_service_type_support_handle.typesupport_identifier) {
    gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_service_type_support_handle.data;
  ...
  return &gazebo_msgs__srv__set_model_configuration__rosidl_typesupport_introspection_c__SetModelConfiguration_service_type_support_handle;
}
