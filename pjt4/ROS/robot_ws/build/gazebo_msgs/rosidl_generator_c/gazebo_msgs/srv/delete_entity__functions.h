...
#ifndef GAZEBO_MSGS__SRV__DELETE_ENTITY__FUNCTIONS_H_
#define GAZEBO_MSGS__SRV__DELETE_ENTITY__FUNCTIONS_H_
...
#endif  // GAZEBO_MSGS__SRV__DELETE_ENTITY__FUNCTIONS_H_
