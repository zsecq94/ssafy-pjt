...
#ifndef GAZEBO_MSGS__SRV__GET_JOINT_PROPERTIES__STRUCT_H_
#define GAZEBO_MSGS__SRV__GET_JOINT_PROPERTIES__STRUCT_H_
...
typedef struct gazebo_msgs__srv__GetJointProperties_Response
{
  ...
  rosidl_generator_c__double__Sequence rate;
  bool success;
...
#endif  // GAZEBO_MSGS__SRV__GET_JOINT_PROPERTIES__STRUCT_H_
