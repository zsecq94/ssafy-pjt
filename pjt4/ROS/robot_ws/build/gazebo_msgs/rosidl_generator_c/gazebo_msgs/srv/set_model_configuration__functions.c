...
gazebo_msgs__srv__SetModelConfiguration_Request__init(gazebo_msgs__srv__SetModelConfiguration_Request * msg)
{
  ...
  // urdf_param_name
  if (!rosidl_generator_c__String__init(&msg->urdf_param_name)) {
    gazebo_msgs__srv__SetModelConfiguration_Request__fini(msg);
    return false;
  }
  // joint_names
  ...
  // joint_positions
  if (!rosidl_generator_c__double__Sequence__init(&msg->joint_positions, 0)) {
    gazebo_msgs__srv__SetModelConfiguration_Request__fini(msg);
    return false;
  }
  return true;
...
gazebo_msgs__srv__SetModelConfiguration_Request__fini(gazebo_msgs__srv__SetModelConfiguration_Request * msg)
{
  ...
  // urdf_param_name
  rosidl_generator_c__String__fini(&msg->urdf_param_name);
  // joint_names
  rosidl_generator_c__String__Sequence__fini(&msg->joint_names);
  // joint_positions
  rosidl_generator_c__double__Sequence__fini(&msg->joint_positions);
}
