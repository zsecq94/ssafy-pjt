...
gazebo_msgs__srv__GetModelProperties_Response__init(gazebo_msgs__srv__GetModelProperties_Response * msg)
{
  ...
  // parent_model_name
  if (!rosidl_generator_c__String__init(&msg->parent_model_name)) {
    gazebo_msgs__srv__GetModelProperties_Response__fini(msg);
    return false;
  }
  // canonical_body_name
  if (!rosidl_generator_c__String__init(&msg->canonical_body_name)) {
    gazebo_msgs__srv__GetModelProperties_Response__fini(msg);
    return false;
  }
  // body_names
  if (!rosidl_generator_c__String__Sequence__init(&msg->body_names, 0)) {
    gazebo_msgs__srv__GetModelProperties_Response__fini(msg);
    return false;
  }
  // geom_names
  if (!rosidl_generator_c__String__Sequence__init(&msg->geom_names, 0)) {
    gazebo_msgs__srv__GetModelProperties_Response__fini(msg);
    return false;
  }
  // joint_names
  ...
  // child_model_names
  if (!rosidl_generator_c__String__Sequence__init(&msg->child_model_names, 0)) {
    gazebo_msgs__srv__GetModelProperties_Response__fini(msg);
    return false;
  }
  // is_static
...
gazebo_msgs__srv__GetModelProperties_Response__fini(gazebo_msgs__srv__GetModelProperties_Response * msg)
{
  ...
  // parent_model_name
  rosidl_generator_c__String__fini(&msg->parent_model_name);
  // canonical_body_name
  rosidl_generator_c__String__fini(&msg->canonical_body_name);
  // body_names
  rosidl_generator_c__String__Sequence__fini(&msg->body_names);
  // geom_names
  rosidl_generator_c__String__Sequence__fini(&msg->geom_names);
  // joint_names
  rosidl_generator_c__String__Sequence__fini(&msg->joint_names);
  // child_model_names
  rosidl_generator_c__String__Sequence__fini(&msg->child_model_names);
  // is_static
  // success
  // status_message
