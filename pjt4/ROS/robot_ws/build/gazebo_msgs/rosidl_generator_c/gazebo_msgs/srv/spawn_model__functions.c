...
gazebo_msgs__srv__SpawnModel_Request__init(gazebo_msgs__srv__SpawnModel_Request * msg)
{
  ...
  // model_xml
  if (!rosidl_generator_c__String__init(&msg->model_xml)) {
    gazebo_msgs__srv__SpawnModel_Request__fini(msg);
    return false;
  }
  // robot_namespace
  if (!rosidl_generator_c__String__init(&msg->robot_namespace)) {
    gazebo_msgs__srv__SpawnModel_Request__fini(msg);
    return false;
  }
  // initial_pose
...
gazebo_msgs__srv__SpawnModel_Request__fini(gazebo_msgs__srv__SpawnModel_Request * msg)
{
  ...
  // model_xml
  rosidl_generator_c__String__fini(&msg->model_xml);
  // robot_namespace
  rosidl_generator_c__String__fini(&msg->robot_namespace);
  // initial_pose
