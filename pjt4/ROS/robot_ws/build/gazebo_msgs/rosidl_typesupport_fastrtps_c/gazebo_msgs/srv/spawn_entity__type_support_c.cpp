...
#include "gazebo_msgs/srv/spawn_entity__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // name, reference_frame, robot_namespace, xml
#include "rosidl_generator_c/string_functions.h"  // name, reference_frame, robot_namespace, xml
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: xml
  {
    const rosidl_generator_c__String * str = &ros_message->xml;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: xml
  {
    ...
    if (!ros_message->xml.data) {
      rosidl_generator_c__String__init(&ros_message->xml);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->xml,
      tmp.c_str());
