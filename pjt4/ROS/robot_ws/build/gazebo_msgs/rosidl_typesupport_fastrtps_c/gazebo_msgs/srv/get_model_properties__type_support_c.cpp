...
#include "gazebo_msgs/srv/get_model_properties__rosidl_typesupport_fastrtps_c.h"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->model_name;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: model_name
  {
    ...
    if (!ros_message->model_name.data) {
      rosidl_generator_c__String__init(&ros_message->model_name);
    }
...
// already included above
// #include "rosidl_generator_c/string.h"  // body_names, canonical_body_name, child_model_names, geom_names, joint_names, parent_model_name, status_message
// already included above
// #include "rosidl_generator_c/string_functions.h"  // body_names, canonical_body_name, child_model_names, geom_names, joint_names, parent_model_name, status_message
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->parent_model_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->canonical_body_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: parent_model_name
  {
    ...
    if (!ros_message->parent_model_name.data) {
      rosidl_generator_c__String__init(&ros_message->parent_model_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: canonical_body_name
  {
    ...
    if (!ros_message->canonical_body_name.data) {
      rosidl_generator_c__String__init(&ros_message->canonical_body_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: body_names
  {
    ...
    if (ros_message->body_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->body_names);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->body_names, size)) {
  ...
  // Field name: geom_names
  {
    ...
    if (ros_message->geom_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->geom_names);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->geom_names, size)) {
  ...
  // Field name: child_model_names
  {
    ...
    if (ros_message->child_model_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->child_model_names);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->child_model_names, size)) {
