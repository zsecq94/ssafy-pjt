...
#include "gazebo_msgs/srv/get_joint_properties__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // joint_name
#include "rosidl_generator_c/string_functions.h"  // joint_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->joint_name;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: joint_name
  {
    ...
    if (!ros_message->joint_name.data) {
      rosidl_generator_c__String__init(&ros_message->joint_name);
    }
...
#include "rosidl_generator_c/primitives_sequence.h"  // damping, position, rate
#include "rosidl_generator_c/primitives_sequence_functions.h"  // damping, position, rate
// already included above
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: rate
  {
    ...
    if (ros_message->rate.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->rate);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->rate, size)) {
