...
#include "gazebo_msgs/msg/contact_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/vector3__functions.h"  // contact_normals, contact_positions
#include "geometry_msgs/msg/wrench__functions.h"  // total_wrench, wrenches
#include "rosidl_generator_c/primitives_sequence.h"  // depths
#include "rosidl_generator_c/primitives_sequence_functions.h"  // depths
#include "rosidl_generator_c/string.h"  // collision1_name, collision2_name, info
#include "rosidl_generator_c/string_functions.h"  // collision1_name, collision2_name, info
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: info
  {
    const rosidl_generator_c__String * str = &ros_message->info;
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->collision1_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->collision2_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: info
  {
    ...
    if (!ros_message->info.data) {
      rosidl_generator_c__String__init(&ros_message->info);
    }
  ...
  // Field name: collision1_name
  {
    ...
    if (!ros_message->collision1_name.data) {
      rosidl_generator_c__String__init(&ros_message->collision1_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: collision2_name
  {
    ...
    if (!ros_message->collision2_name.data) {
      rosidl_generator_c__String__init(&ros_message->collision2_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: depths
  {
    ...
    if (ros_message->depths.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->depths);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->depths, size)) {
