...
#include "gazebo_msgs/msg/ode_joint_properties__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // cfm, damping, erp, fmax, fudge_factor, hi_stop, lo_stop, stop_cfm, stop_erp, vel
#include "rosidl_generator_c/primitives_sequence_functions.h"  // cfm, damping, erp, fmax, fudge_factor, hi_stop, lo_stop, stop_cfm, stop_erp, vel
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: damping
  {
    ...
    if (ros_message->damping.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->damping);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->damping, size)) {
  ...
  // Field name: hi_stop
  {
    ...
    if (ros_message->hi_stop.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->hi_stop);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->hi_stop, size)) {
  ...
  // Field name: lo_stop
  {
    ...
    if (ros_message->lo_stop.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->lo_stop);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->lo_stop, size)) {
  ...
  // Field name: erp
  {
    ...
    if (ros_message->erp.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->erp);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->erp, size)) {
  ...
  // Field name: cfm
  {
    ...
    if (ros_message->cfm.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->cfm);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->cfm, size)) {
  ...
  // Field name: stop_erp
  {
    ...
    if (ros_message->stop_erp.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->stop_erp);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->stop_erp, size)) {
  ...
  // Field name: stop_cfm
  {
    ...
    if (ros_message->stop_cfm.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->stop_cfm);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->stop_cfm, size)) {
  ...
  // Field name: fudge_factor
  {
    ...
    if (ros_message->fudge_factor.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->fudge_factor);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->fudge_factor, size)) {
  ...
  // Field name: fmax
  {
    ...
    if (ros_message->fmax.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->fmax);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->fmax, size)) {
  ...
  // Field name: vel
  {
    ...
    if (ros_message->vel.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->vel);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->vel, size)) {
