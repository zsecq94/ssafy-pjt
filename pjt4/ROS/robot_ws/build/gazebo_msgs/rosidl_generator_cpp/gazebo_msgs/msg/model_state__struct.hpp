...
#ifndef GAZEBO_MSGS__MSG__MODEL_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__MSG__MODEL_STATE__STRUCT_HPP_
...
struct ModelState_
{
  ...
  explicit ModelState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init),
    twist(_init)
  {
  ...
  explicit ModelState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : model_name(_alloc),
    pose(_alloc, _init),
    twist(_alloc, _init),
...
#endif  // GAZEBO_MSGS__MSG__MODEL_STATE__STRUCT_HPP_
