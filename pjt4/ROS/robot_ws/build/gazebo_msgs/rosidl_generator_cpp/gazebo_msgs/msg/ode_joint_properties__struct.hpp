...
#ifndef GAZEBO_MSGS__MSG__ODE_JOINT_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__MSG__ODE_JOINT_PROPERTIES__STRUCT_HPP_
...
struct ODEJointProperties_
{
  ...
  explicit ODEJointProperties_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit ODEJointProperties_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // GAZEBO_MSGS__MSG__ODE_JOINT_PROPERTIES__STRUCT_HPP_
