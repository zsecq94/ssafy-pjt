...
#ifndef GAZEBO_MSGS__MSG__CONTACTS_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__MSG__CONTACTS_STATE__STRUCT_HPP_
...
struct ContactsState_
{
  ...
  explicit ContactsState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit ContactsState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // GAZEBO_MSGS__MSG__CONTACTS_STATE__STRUCT_HPP_
