...
#ifndef GAZEBO_MSGS__SRV__SET_MODEL_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SET_MODEL_STATE__STRUCT_HPP_
...
struct SetModelState_Request_
{
  ...
  explicit SetModelState_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : model_state(_init)
  {
    (void)_init;
  }

  explicit SetModelState_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct SetModelState_Response_
{
  ...
  explicit SetModelState_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SetModelState_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SET_MODEL_STATE__STRUCT_HPP_
