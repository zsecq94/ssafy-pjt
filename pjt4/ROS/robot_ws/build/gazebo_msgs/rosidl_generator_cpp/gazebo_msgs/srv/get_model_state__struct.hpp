...
#ifndef GAZEBO_MSGS__SRV__GET_MODEL_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__GET_MODEL_STATE__STRUCT_HPP_
...
struct GetModelState_Request_
{
  ...
  explicit GetModelState_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetModelState_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : model_name(_alloc),
...
struct GetModelState_Response_
{
  ...
  explicit GetModelState_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    pose(_init),
    twist(_init)
  {
  ...
  explicit GetModelState_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    pose(_alloc, _init),
    twist(_alloc, _init),
...
#endif  // GAZEBO_MSGS__SRV__GET_MODEL_STATE__STRUCT_HPP_
