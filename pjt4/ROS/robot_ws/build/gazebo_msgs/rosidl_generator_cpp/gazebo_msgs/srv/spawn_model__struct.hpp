...
#ifndef GAZEBO_MSGS__SRV__SPAWN_MODEL__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SPAWN_MODEL__STRUCT_HPP_
...
struct SpawnModel_Request_
{
  ...
  explicit SpawnModel_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : initial_pose(_init)
  {
  ...
  explicit SpawnModel_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : model_name(_alloc),
    model_xml(_alloc),
...
struct SpawnModel_Response_
{
  ...
  explicit SpawnModel_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SpawnModel_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SPAWN_MODEL__STRUCT_HPP_
