...
#ifndef GAZEBO_MSGS__SRV__GET_WORLD_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__GET_WORLD_PROPERTIES__STRUCT_HPP_
...
struct GetWorldProperties_Request_
{
  ...
  explicit GetWorldProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetWorldProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct GetWorldProperties_Response_
{
  ...
  explicit GetWorldProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit GetWorldProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__GET_WORLD_PROPERTIES__STRUCT_HPP_
