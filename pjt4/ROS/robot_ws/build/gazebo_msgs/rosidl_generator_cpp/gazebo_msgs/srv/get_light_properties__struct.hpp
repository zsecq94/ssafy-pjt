...
#ifndef GAZEBO_MSGS__SRV__GET_LIGHT_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__GET_LIGHT_PROPERTIES__STRUCT_HPP_
...
struct GetLightProperties_Request_
{
  ...
  explicit GetLightProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetLightProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : light_name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct GetLightProperties_Response_
{
  ...
  explicit GetLightProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : diffuse(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  explicit GetLightProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__GET_LIGHT_PROPERTIES__STRUCT_HPP_
