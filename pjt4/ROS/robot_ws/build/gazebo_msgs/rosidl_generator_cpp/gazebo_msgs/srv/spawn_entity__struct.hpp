...
#ifndef GAZEBO_MSGS__SRV__SPAWN_ENTITY__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SPAWN_ENTITY__STRUCT_HPP_
...
struct SpawnEntity_Request_
{
  ...
  explicit SpawnEntity_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : initial_pose(_init)
  {
  ...
  explicit SpawnEntity_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc),
    xml(_alloc),
...
struct SpawnEntity_Response_
{
  ...
  explicit SpawnEntity_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SpawnEntity_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SPAWN_ENTITY__STRUCT_HPP_
