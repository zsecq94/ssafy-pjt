...
#ifndef GAZEBO_MSGS__SRV__SET_LINK_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SET_LINK_PROPERTIES__STRUCT_HPP_
...
struct SetLinkProperties_Request_
{
  ...
  explicit SetLinkProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : com(_init)
  {
  ...
  explicit SetLinkProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : link_name(_alloc),
    com(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
struct SetLinkProperties_Response_
{
  ...
  explicit SetLinkProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SetLinkProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SET_LINK_PROPERTIES__STRUCT_HPP_
