...
#ifndef GAZEBO_MSGS__SRV__GET_LINK_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__GET_LINK_PROPERTIES__STRUCT_HPP_
...
struct GetLinkProperties_Request_
{
  ...
  explicit GetLinkProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetLinkProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : link_name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct GetLinkProperties_Response_
{
  ...
  explicit GetLinkProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : com(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  explicit GetLinkProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : com(_alloc, _init),
...
#endif  // GAZEBO_MSGS__SRV__GET_LINK_PROPERTIES__STRUCT_HPP_
