...
#ifndef GAZEBO_MSGS__SRV__GET_ENTITY_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__GET_ENTITY_STATE__STRUCT_HPP_
...
struct GetEntityState_Request_
{
  ...
  explicit GetEntityState_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetEntityState_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc),
...
struct GetEntityState_Response_
{
  ...
  explicit GetEntityState_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    state(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
  ...
  explicit GetEntityState_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    state(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // GAZEBO_MSGS__SRV__GET_ENTITY_STATE__STRUCT_HPP_
