...
static const _LogicalCameraImage_type_support_symbol_names_t _LogicalCameraImage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, msg, LogicalCameraImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, msg, LogicalCameraImage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, msg, LogicalCameraImage)() {
  return &::gazebo_msgs::msg::rosidl_typesupport_c::LogicalCameraImage_message_type_support_handle;
}
