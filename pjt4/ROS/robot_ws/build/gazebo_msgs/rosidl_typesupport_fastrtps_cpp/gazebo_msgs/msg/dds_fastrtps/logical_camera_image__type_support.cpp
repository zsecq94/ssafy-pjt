...
#include "gazebo_msgs/msg/logical_camera_image__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gazebo_msgs::msg::LogicalCameraImage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gazebo_msgs::msg::LogicalCameraImage & ros_message)
{
  // Member: camera_pose
  ...
  // Member: model_pose
  {
    ...
    ros_message.model_pose.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.model_pose[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: model_name
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.model_name[index].size() + 1);
    }
  }
  // Member: model_pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.model_pose[index], current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const gazebo_msgs::msg::LogicalCameraImage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gazebo_msgs::msg::LogicalCameraImage *>(
    untyped_ros_message);
...
{
  return max_serialized_size_LogicalCameraImage(full_bounded, 0);
}
...
{
  return &gazebo_msgs::msg::typesupport_fastrtps_cpp::_LogicalCameraImage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gazebo_msgs, msg, LogicalCameraImage)() {
  return &gazebo_msgs::msg::typesupport_fastrtps_cpp::_LogicalCameraImage__handle;
}
