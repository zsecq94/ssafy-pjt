...
#ifndef GAZEBO_MSGS__SRV__SET_MODEL_CONFIGURATION__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SET_MODEL_CONFIGURATION__STRUCT_HPP_
...
struct SetModelConfiguration_Request_
{
  ...
  explicit SetModelConfiguration_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SetModelConfiguration_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : model_name(_alloc),
...
struct SetModelConfiguration_Response_
{
  ...
  explicit SetModelConfiguration_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SetModelConfiguration_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SET_MODEL_CONFIGURATION__STRUCT_HPP_
