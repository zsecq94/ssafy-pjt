...
#ifndef GAZEBO_MSGS__SRV__SET_JOINT_PROPERTIES__STRUCT_H_
#define GAZEBO_MSGS__SRV__SET_JOINT_PROPERTIES__STRUCT_H_
...
#endif  // GAZEBO_MSGS__SRV__SET_JOINT_PROPERTIES__STRUCT_H_
