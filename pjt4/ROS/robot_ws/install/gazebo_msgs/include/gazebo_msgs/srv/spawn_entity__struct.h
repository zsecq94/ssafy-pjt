...
#ifndef GAZEBO_MSGS__SRV__SPAWN_ENTITY__STRUCT_H_
#define GAZEBO_MSGS__SRV__SPAWN_ENTITY__STRUCT_H_
...
typedef struct gazebo_msgs__srv__SpawnEntity_Request
{
  ...
  rosidl_generator_c__String xml;
...
#endif  // GAZEBO_MSGS__SRV__SPAWN_ENTITY__STRUCT_H_
