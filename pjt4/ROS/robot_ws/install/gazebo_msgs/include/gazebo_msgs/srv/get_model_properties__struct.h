...
#ifndef GAZEBO_MSGS__SRV__GET_MODEL_PROPERTIES__STRUCT_H_
#define GAZEBO_MSGS__SRV__GET_MODEL_PROPERTIES__STRUCT_H_
...
{
  rosidl_generator_c__String parent_model_name;
  rosidl_generator_c__String canonical_body_name;
  rosidl_generator_c__String__Sequence body_names;
  rosidl_generator_c__String__Sequence geom_names;
  rosidl_generator_c__String__Sequence joint_names;
  rosidl_generator_c__String__Sequence child_model_names;
  bool is_static;
  bool success;
...
#endif  // GAZEBO_MSGS__SRV__GET_MODEL_PROPERTIES__STRUCT_H_
