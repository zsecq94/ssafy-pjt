...
#ifndef GAZEBO_MSGS__SRV__SET_PHYSICS_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SET_PHYSICS_PROPERTIES__STRUCT_HPP_
...
struct SetPhysicsProperties_Request_
{
  ...
  explicit SetPhysicsProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : gravity(_init),
    ode_config(_init)
  {
  ...
  explicit SetPhysicsProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct SetPhysicsProperties_Response_
{
  ...
  explicit SetPhysicsProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SetPhysicsProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SET_PHYSICS_PROPERTIES__STRUCT_HPP_
