...
#ifndef GAZEBO_MSGS__SRV__APPLY_JOINT_EFFORT__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__APPLY_JOINT_EFFORT__STRUCT_HPP_
...
struct ApplyJointEffort_Request_
{
  ...
  explicit ApplyJointEffort_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : start_time(_init),
    duration(_init)
  {
  ...
  explicit ApplyJointEffort_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : joint_name(_alloc),
...
struct ApplyJointEffort_Response_
{
  ...
  explicit ApplyJointEffort_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit ApplyJointEffort_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__APPLY_JOINT_EFFORT__STRUCT_HPP_
