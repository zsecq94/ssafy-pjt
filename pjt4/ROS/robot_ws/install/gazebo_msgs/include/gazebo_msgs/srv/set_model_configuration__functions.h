...
#ifndef GAZEBO_MSGS__SRV__SET_MODEL_CONFIGURATION__FUNCTIONS_H_
#define GAZEBO_MSGS__SRV__SET_MODEL_CONFIGURATION__FUNCTIONS_H_
...
#endif  // GAZEBO_MSGS__SRV__SET_MODEL_CONFIGURATION__FUNCTIONS_H_
