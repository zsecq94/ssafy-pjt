...
#ifndef GAZEBO_MSGS__SRV__GET_ENTITY_STATE__FUNCTIONS_H_
#define GAZEBO_MSGS__SRV__GET_ENTITY_STATE__FUNCTIONS_H_
...
#endif  // GAZEBO_MSGS__SRV__GET_ENTITY_STATE__FUNCTIONS_H_
