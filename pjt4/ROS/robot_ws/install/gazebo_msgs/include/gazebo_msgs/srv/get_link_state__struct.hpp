...
#ifndef GAZEBO_MSGS__SRV__GET_LINK_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__GET_LINK_STATE__STRUCT_HPP_
...
struct GetLinkState_Request_
{
  ...
  explicit GetLinkState_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetLinkState_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : link_name(_alloc),
...
struct GetLinkState_Response_
{
  ...
  explicit GetLinkState_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : link_state(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  explicit GetLinkState_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__GET_LINK_STATE__STRUCT_HPP_
