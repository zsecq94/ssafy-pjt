...
#ifndef GAZEBO_MSGS__SRV__SET_LINK_STATE__TYPE_SUPPORT_H_
#define GAZEBO_MSGS__SRV__SET_LINK_STATE__TYPE_SUPPORT_H_
...
#endif  // GAZEBO_MSGS__SRV__SET_LINK_STATE__TYPE_SUPPORT_H_
