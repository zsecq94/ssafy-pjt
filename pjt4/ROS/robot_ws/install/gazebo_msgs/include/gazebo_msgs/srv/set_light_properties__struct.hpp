...
#ifndef GAZEBO_MSGS__SRV__SET_LIGHT_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SET_LIGHT_PROPERTIES__STRUCT_HPP_
...
struct SetLightProperties_Request_
{
  ...
  explicit SetLightProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : diffuse(_init)
  {
  ...
  explicit SetLightProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : light_name(_alloc),
...
struct SetLightProperties_Response_
{
  ...
  explicit SetLightProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SetLightProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SET_LIGHT_PROPERTIES__STRUCT_HPP_
