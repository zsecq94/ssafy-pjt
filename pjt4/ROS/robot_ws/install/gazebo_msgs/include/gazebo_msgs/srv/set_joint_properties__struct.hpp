...
#ifndef GAZEBO_MSGS__SRV__SET_JOINT_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SET_JOINT_PROPERTIES__STRUCT_HPP_
...
struct SetJointProperties_Request_
{
  ...
  explicit SetJointProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit SetJointProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : joint_name(_alloc),
...
struct SetJointProperties_Response_
{
  ...
  explicit SetJointProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SetJointProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SET_JOINT_PROPERTIES__STRUCT_HPP_
