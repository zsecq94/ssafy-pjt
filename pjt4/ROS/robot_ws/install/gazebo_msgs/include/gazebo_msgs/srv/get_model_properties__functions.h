...
#ifndef GAZEBO_MSGS__SRV__GET_MODEL_PROPERTIES__FUNCTIONS_H_
#define GAZEBO_MSGS__SRV__GET_MODEL_PROPERTIES__FUNCTIONS_H_
...
#endif  // GAZEBO_MSGS__SRV__GET_MODEL_PROPERTIES__FUNCTIONS_H_
