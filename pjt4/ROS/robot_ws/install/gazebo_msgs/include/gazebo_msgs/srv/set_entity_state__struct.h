...
#ifndef GAZEBO_MSGS__SRV__SET_ENTITY_STATE__STRUCT_H_
#define GAZEBO_MSGS__SRV__SET_ENTITY_STATE__STRUCT_H_
...
#endif  // GAZEBO_MSGS__SRV__SET_ENTITY_STATE__STRUCT_H_
