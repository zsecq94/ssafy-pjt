...
#ifndef GAZEBO_MSGS__SRV__SET_JOINT_TRAJECTORY__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__SET_JOINT_TRAJECTORY__STRUCT_HPP_
...
struct SetJointTrajectory_Request_
{
  ...
  explicit SetJointTrajectory_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit SetJointTrajectory_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : model_name(_alloc),
...
struct SetJointTrajectory_Response_
{
  ...
  explicit SetJointTrajectory_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SetJointTrajectory_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__SET_JOINT_TRAJECTORY__STRUCT_HPP_
