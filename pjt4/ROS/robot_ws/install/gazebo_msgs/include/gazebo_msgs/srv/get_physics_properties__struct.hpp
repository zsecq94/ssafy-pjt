...
#ifndef GAZEBO_MSGS__SRV__GET_PHYSICS_PROPERTIES__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__GET_PHYSICS_PROPERTIES__STRUCT_HPP_
...
struct GetPhysicsProperties_Request_
{
  ...
  explicit GetPhysicsProperties_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetPhysicsProperties_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct GetPhysicsProperties_Response_
{
  ...
  explicit GetPhysicsProperties_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : gravity(_init),
    ode_config(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
  ...
  explicit GetPhysicsProperties_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__GET_PHYSICS_PROPERTIES__STRUCT_HPP_
