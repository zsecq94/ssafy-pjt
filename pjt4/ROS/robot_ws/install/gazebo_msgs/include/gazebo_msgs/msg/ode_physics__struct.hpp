...
#ifndef GAZEBO_MSGS__MSG__ODE_PHYSICS__STRUCT_HPP_
#define GAZEBO_MSGS__MSG__ODE_PHYSICS__STRUCT_HPP_
...
struct ODEPhysics_
{
  ...
  explicit ODEPhysics_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ODEPhysics_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // GAZEBO_MSGS__MSG__ODE_PHYSICS__STRUCT_HPP_
