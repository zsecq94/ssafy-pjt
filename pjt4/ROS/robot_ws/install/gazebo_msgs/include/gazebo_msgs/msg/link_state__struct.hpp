...
#ifndef GAZEBO_MSGS__MSG__LINK_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__MSG__LINK_STATE__STRUCT_HPP_
...
struct LinkState_
{
  ...
  explicit LinkState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init),
    twist(_init)
  {
  ...
  explicit LinkState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : link_name(_alloc),
    pose(_alloc, _init),
    twist(_alloc, _init),
...
#endif  // GAZEBO_MSGS__MSG__LINK_STATE__STRUCT_HPP_
