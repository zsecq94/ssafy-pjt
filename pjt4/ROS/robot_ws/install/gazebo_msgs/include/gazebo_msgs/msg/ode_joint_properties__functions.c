...
gazebo_msgs__msg__ODEJointProperties__init(gazebo_msgs__msg__ODEJointProperties * msg)
{
  ...
  // hi_stop
  if (!rosidl_generator_c__double__Sequence__init(&msg->hi_stop, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // lo_stop
  if (!rosidl_generator_c__double__Sequence__init(&msg->lo_stop, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // erp
  if (!rosidl_generator_c__double__Sequence__init(&msg->erp, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // cfm
  if (!rosidl_generator_c__double__Sequence__init(&msg->cfm, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // stop_erp
  if (!rosidl_generator_c__double__Sequence__init(&msg->stop_erp, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // stop_cfm
  if (!rosidl_generator_c__double__Sequence__init(&msg->stop_cfm, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // fudge_factor
  if (!rosidl_generator_c__double__Sequence__init(&msg->fudge_factor, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // fmax
  if (!rosidl_generator_c__double__Sequence__init(&msg->fmax, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  // vel
  if (!rosidl_generator_c__double__Sequence__init(&msg->vel, 0)) {
    gazebo_msgs__msg__ODEJointProperties__fini(msg);
    return false;
  }
  return true;
...
gazebo_msgs__msg__ODEJointProperties__fini(gazebo_msgs__msg__ODEJointProperties * msg)
{
  ...
  // hi_stop
  rosidl_generator_c__double__Sequence__fini(&msg->hi_stop);
  // lo_stop
  rosidl_generator_c__double__Sequence__fini(&msg->lo_stop);
  // erp
  rosidl_generator_c__double__Sequence__fini(&msg->erp);
  // cfm
  rosidl_generator_c__double__Sequence__fini(&msg->cfm);
  // stop_erp
  rosidl_generator_c__double__Sequence__fini(&msg->stop_erp);
  // stop_cfm
  rosidl_generator_c__double__Sequence__fini(&msg->stop_cfm);
  // fudge_factor
  rosidl_generator_c__double__Sequence__fini(&msg->fudge_factor);
  // fmax
  rosidl_generator_c__double__Sequence__fini(&msg->fmax);
  // vel
  rosidl_generator_c__double__Sequence__fini(&msg->vel);
}
