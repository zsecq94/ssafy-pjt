...
#ifndef GAZEBO_MSGS__MSG__CONTACT_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__MSG__CONTACT_STATE__STRUCT_HPP_
...
struct ContactState_
{
  ...
  explicit ContactState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : total_wrench(_init)
  {
  ...
  explicit ContactState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : info(_alloc),
...
#endif  // GAZEBO_MSGS__MSG__CONTACT_STATE__STRUCT_HPP_
