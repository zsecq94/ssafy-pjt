...
#ifndef GAZEBO_MSGS__MSG__WORLD_STATE__STRUCT_HPP_
#define GAZEBO_MSGS__MSG__WORLD_STATE__STRUCT_HPP_
...
struct WorldState_
{
  ...
  explicit WorldState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit WorldState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // GAZEBO_MSGS__MSG__WORLD_STATE__STRUCT_HPP_
