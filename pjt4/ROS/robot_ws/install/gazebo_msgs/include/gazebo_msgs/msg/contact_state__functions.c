...
gazebo_msgs__msg__ContactState__init(gazebo_msgs__msg__ContactState * msg)
{
  ...
  // info
  if (!rosidl_generator_c__String__init(&msg->info)) {
    gazebo_msgs__msg__ContactState__fini(msg);
    return false;
  }
  // collision1_name
  if (!rosidl_generator_c__String__init(&msg->collision1_name)) {
    gazebo_msgs__msg__ContactState__fini(msg);
    return false;
  }
  // collision2_name
  if (!rosidl_generator_c__String__init(&msg->collision2_name)) {
    gazebo_msgs__msg__ContactState__fini(msg);
    return false;
  }
  // wrenches
  ...
  // depths
  if (!rosidl_generator_c__double__Sequence__init(&msg->depths, 0)) {
    gazebo_msgs__msg__ContactState__fini(msg);
    return false;
  }
  return true;
...
gazebo_msgs__msg__ContactState__fini(gazebo_msgs__msg__ContactState * msg)
{
  ...
  // info
  rosidl_generator_c__String__fini(&msg->info);
  // collision1_name
  rosidl_generator_c__String__fini(&msg->collision1_name);
  // collision2_name
  rosidl_generator_c__String__fini(&msg->collision2_name);
  // wrenches
  ...
  // depths
  rosidl_generator_c__double__Sequence__fini(&msg->depths);
}
