...
#ifndef GAZEBO_MSGS__MSG__CONTACT_STATE__STRUCT_H_
#define GAZEBO_MSGS__MSG__CONTACT_STATE__STRUCT_H_
...
{
  rosidl_generator_c__String info;
  rosidl_generator_c__String collision1_name;
  rosidl_generator_c__String collision2_name;
  ...
  rosidl_generator_c__double__Sequence depths;
...
#endif  // GAZEBO_MSGS__MSG__CONTACT_STATE__STRUCT_H_
