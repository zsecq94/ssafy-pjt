...
bool gazebo_msgs__msg__contact_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "gazebo_msgs.msg._contact_state.ContactState",
  ...
  {  // info
    ...
    rosidl_generator_c__String__assign(&ros_message->info, PyBytes_AS_STRING(encoded_field));
  ...
  {  // collision1_name
    ...
    rosidl_generator_c__String__assign(&ros_message->collision1_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // collision2_name
    ...
    rosidl_generator_c__String__assign(&ros_message->collision2_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // wrenches
