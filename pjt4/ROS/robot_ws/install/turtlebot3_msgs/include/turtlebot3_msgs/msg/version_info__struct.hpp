...
#ifndef TURTLEBOT3_MSGS__MSG__VERSION_INFO__STRUCT_HPP_
#define TURTLEBOT3_MSGS__MSG__VERSION_INFO__STRUCT_HPP_
...
struct VersionInfo_
{
  ...
  explicit VersionInfo_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VersionInfo_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : hardware(_alloc),
    firmware(_alloc),
    software(_alloc)
  {
...
#endif  // TURTLEBOT3_MSGS__MSG__VERSION_INFO__STRUCT_HPP_
