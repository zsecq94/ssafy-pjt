...
static rosidl_typesupport_introspection_c__ServiceMembers turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_service_members = {
  "turtlebot3_msgs__srv",  // service namespace
  "Dqn",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_Request_message_type_support_handle,
  NULL  // response message
  // turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_service_type_support_handle = {
  0,
  &turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, srv, Dqn)() {
  if (!turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_service_type_support_handle.typesupport_identifier) {
    turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_service_type_support_handle.data;
  ...
  return &turtlebot3_msgs__srv__dqn__rosidl_typesupport_introspection_c__Dqn_service_type_support_handle;
}
