...
#include <stddef.h>
#include "turtlebot3_msgs/action/patrol__rosidl_typesupport_introspection_c.h"
#include "turtlebot3_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "turtlebot3_msgs/action/patrol__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_members = {
  "turtlebot3_msgs__action",  // service namespace
  "Patrol_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle = {
  0,
  &turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, action, Patrol_SendGoal)() {
  if (!turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle.typesupport_identifier) {
    turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle.data;
  ...
  return &turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_members = {
  "turtlebot3_msgs__action",  // service namespace
  "Patrol_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle = {
  0,
  &turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot3_msgs, action, Patrol_GetResult)() {
  if (!turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle.typesupport_identifier) {
    turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle.data;
  ...
  return &turtlebot3_msgs__action__patrol__rosidl_typesupport_introspection_c__Patrol_GetResult_service_type_support_handle;
}
