...
#include <stddef.h>
#include "dynamixel_sdk_custom_interfaces/srv/get_position__rosidl_typesupport_introspection_c.h"
...
#include "dynamixel_sdk_custom_interfaces/srv/get_position__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_service_members = {
  "dynamixel_sdk_custom_interfaces__srv",  // service namespace
  "GetPosition",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_Request_message_type_support_handle,
  NULL  // response message
  // dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_Response_message_type_support_handle
};

static rosidl_service_type_support_t dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle = {
  0,
  &dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamixel_sdk_custom_interfaces, srv, GetPosition)() {
  if (!dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle.typesupport_identifier) {
    dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle.data;
  ...
  return &dynamixel_sdk_custom_interfaces__srv__get_position__rosidl_typesupport_introspection_c__GetPosition_service_type_support_handle;
}
