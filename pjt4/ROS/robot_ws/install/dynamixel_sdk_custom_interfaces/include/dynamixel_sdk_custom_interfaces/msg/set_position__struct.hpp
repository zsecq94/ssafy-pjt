...
#ifndef DYNAMIXEL_SDK_CUSTOM_INTERFACES__MSG__SET_POSITION__STRUCT_HPP_
#define DYNAMIXEL_SDK_CUSTOM_INTERFACES__MSG__SET_POSITION__STRUCT_HPP_
...
struct SetPosition_
{
  ...
  explicit SetPosition_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SetPosition_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // DYNAMIXEL_SDK_CUSTOM_INTERFACES__MSG__SET_POSITION__STRUCT_HPP_
