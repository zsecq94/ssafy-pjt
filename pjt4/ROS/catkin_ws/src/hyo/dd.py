...
def driver_module():
    ...
    rospy.Subscriber('driver', String, callback)

    # Publisher for 'DriverToMain' topic
    pub = rospy.Publisher('DriverToMain', String, queue_size=10)
	...
	jsonData = {'0':str(current_time)}
        pub.publish(json.dumps(jsonData))
        rate.sleep()
